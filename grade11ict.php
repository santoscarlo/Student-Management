...
<h2 align="center"> LIST OF ALL Grade 11 - ICT SUBJECTS </h2>
</div></div>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='ICT' AND yearlevel='grade 11 shs' or yearlevel='GRADE 11 SHS' AND section='ICT - UNIX' OR section='ICT - VISTA'");

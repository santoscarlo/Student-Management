...
if(isset($_POST['submit'])) 
  {
    ...
    $query = "SELECT * from attendance_records where SubjID = '$SubjID' AND studentnumber = '$StudID' and lastname = '$lastname' AND firstname = '$firstname' AND firstname = '$firstname' AND date = '$date'";
...
<div class=""><img src="img/logo1.png" align="left" width="199px" height="100"/></div>
      ...
      .'<br></h3>
         ...
         <span style="font-size: 15px;"><div align="right">Date: '.date ("Y-m-d")
      .'<br>Instructor Name: '.$_SESSION['submit'].'<br>
             </div></span>';
       ?>
...
<div class="panel panel-heading">
<h2>
<a class="btn btn-info" href="index.php" id="back">Back</a>
<a class="btn btn-info" href="addirreg.php" id="addirreg">Add irreg</a>
...
function printpage() {
    ...
    var recordadd = document.getElementById("recordadd");
     var addirreg = document.getElementById("addirreg");

    //Set the button visibility to 'hidden' 
    printButton.style.visibility = 'hidden';
    backButton.style.visibility = 'hidden';
    recordadd.style.visibility = 'hidden';
    addirreg.style.visibility = 'hidden';
    ...
    addirreg.style.visibility = 'visible';
}
 </script>
...
<div class="alert alert-info alert-dismissable">
    ...
    <strong><span class="glyphicon glyphicon-ok"></span></strong> Attendance Successfully Recorded!
  </div><?php } ?>
<!--END-->

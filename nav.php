 ...
 <!-- Brand and toggle get grouped for better mobile display -->
      ...
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu">
              ...
              <li><a href="managedropdown.php">Manage Dropdown</a></li>
      </ul>
      </li>
      </ul>
           <li class="dropdown">
         ...
         <ul class="dropdown-menu">
              <li><a href="reports/attendancestatusgraphical.php">Graphical Report</a></li>
              <li><a href="reports/printreports.php">Print Report</a></li>   
      </ul>
      </li>

...
<h3 align="center">Students Total No. of Excuses</h3>
...
<div class="panel panel-body">
                     ...
                     <table class="table table-bordered">  
                          ...
                          $attendance_status = '';
                          $subjID = $_GET['id'];
                          $query = "SELECT distinct studentnumber, lastname, firstname, middlename, studentnumber, attendance_status, count(attendance_status) as 'Count' FROM attendance_records WHERE attendance_status IN ('Excuse') AND SubjID = '$subjID' GROUP BY studentnumber ORDER BY lastname";

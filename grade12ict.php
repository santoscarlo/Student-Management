...
<h2 align="center"> LIST OF ALL Grade 12 - ICT SUBJECTS</h2>
</div></div>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='ICT' AND yearlevel='GRADE 12 SHS' or section = 'ICT - Mark Zuckerburg'  or section = 'ICT - Bill Gate'");

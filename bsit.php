...
<h2 align="center"> LIST OF BSIT - REG SUBJECTS </h2>
</div></div>
...
<div class="jumbotron">
   ...
   <a class="btn btn-info" href="bsitnc.php">BSIT-NC</a>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='BSIT' AND section='BSIT 1 - 1 REG' OR section='BSIT 1 - 2 REG' OR section='BSIT 2 - 1 REG' OR section='BSIT 2 - 2 REG' OR section='BSIT 3 - 1 REG' OR section='BSIT 3 - 2 REG'");

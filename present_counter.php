...
<h3 align="center">Students Total No. of Present</h3>
...
<div class="panel panel-body">
                     ...
                     <table class="table table-bordered">  
                          ...
                          $attendance_status = '';
                          $subjID = $_GET['id'];
                          $query = "SELECT distinct studentnumber, lastname, firstname, middlename, studentnumber, attendance_status, count(attendance_status) as 'Count' FROM attendance_records WHERE attendance_status IN ('Present') AND SubjID = '$subjID' GROUP BY studentnumber ORDER BY lastname";
                              ...
                              elseif($row["Count"]>=3)
                              {
                               ...
                               <tr>  
                                   ...
                                   <td>'.$row["lastname"].'</td> 
                                    ...
                                    <td>'.$row["middlename"].'</td>
                                     <td>'.$row["attendance_status"].'</td>
                            <td style="background-color: #2EFF61; ">'.$row["Count"].'</td>
              ...
              else
              {
                ...
                <tr>
                                  ...
                                  <td>'.$row["studentnumber"].'</td>
                                    ...
                                    <td>'.$row["middlename"].'</td>
                                     <td>'.$row["attendance_status"].'</td>
                                     <td style="background-color:#A5FFBB;  ">'.$row["Count"].'</td>
                                    </tr>

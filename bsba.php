...
<h2 align="center"> LIST OF BSBA - REG SUBJECTS </h2>
</div></div>
...
<div class="jumbotron">
   ...
   <a class="btn btn-info" href="bsbanc.php">BSBA - NC</a>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='BSBA' AND section='BSBA 1 - 1 REG' OR section='BSBA 1 - 2 REG' OR section='BSBA 2 - 1 REG' OR section='BSBA 2 - 2 REG' OR section='BSBA 3 - 1 REG' OR section='BSBA 3 - 2 REG'");

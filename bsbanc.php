...
<h2 align="center"> LIST OF BSBA - NC SUBJECTS</h2>
</div></div>
...
<div class="jumbotron">
   ...
   <a class="btn btn-info" href="bsba.php">BSBA - REG</a>
  ...
  <thead>
          ...
          <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='BSBA' AND section='BSBA 1 - 1 NC' OR section='BSBA 1 - 2 NC' OR section='BSBA 2 - 1 NC' OR section='BSBA 2 - 2 NC' OR section='BSBA 3 - 1 NC' OR section='BSBA 3 - 2 NC'");

...
<h2 align="center"> LIST OF ALL Grade 12 - ABM SUBJECTS</h2>
</div></div>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='ABM' AND yearlevel='grade 12 shs' AND section='abm - steve jobs' or section='ABM - Steve Jobs'");

...
<h2 align="center"> LIST OF BSIT - NC SUBJECTS </h2>
</div></div>
...
<div class="jumbotron">
   ...
   <a class="btn btn-info" href="bsit.php">BSIT</a>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
              ...
              <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='BSIT' AND section='BSIT 1 - 1 NC' OR section='BSIT 1 - 2 NC' OR section='BSIT 2 - 1 NC' OR section='BSIT 2 - 2 NC' OR section='BSIT 3 - 1 NC' OR section='BSIT 3 - 2 NC'");

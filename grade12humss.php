...
<h2 align="center"> LIST OF ALL Grade 12 - HUMSS SUBJECTS</h2>
</div></div>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='HUMSS' and yearlevel='Grade 12 SHS' or section ='HUMSS - GRADE 12'");

...
// HEADER TITLE
    ...
    $this->CELL(0,0,'SUBJECT LOADED TO INSTRUCTOR LIST',0,0,'C');
    $this->Ln();
...
function headerTable(){
 ...
 $this->Cell(45,10,'Subject Name',1,0,'C');
 $this->Cell(52,10,'Instructor Name',1,0,'C');
...
function viewTable($db){
    ...
    $this->Cell(45,10,$data->subjname,1,0,'L');
    $this->Cell(52,10,$data->instructorname,1,0,'L');
...
// TOTAL RECORD COUNT
          ...
          // echo "$row[0]";
                 ...
                 $this->Cell(190,12, 'Total Information Recorded: '.$row[0] ,True, 'L',0);
          mysqli_close($conn);

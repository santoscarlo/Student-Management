...
function headerTable(){
 ...
 $this->Cell(35,10,'Year Level',1,0,'C');
 $this->Cell(49,10,'Parent Contact Number',1,0,'C');
 $this->Ln();

}
function viewTable($db){
    $this->SetFont('Times','',12);
    $stmt = $db->query('SELECT * from studenttable WHERE yearlevel = "GRADE 12 SHS" OR yearlevel = "GRADE 11 SHS"  order by lastname ASC ');
    ...
    $this->Cell(28,10,$data->gender,1,0,'L');
     ...
     $this->Cell(35,10,$data->yearlevel,1,0,'L');
    $this->Cell(49,10,$data->parentcontactnum,1,0,'L');

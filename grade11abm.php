...
<h2 align="center"> LIST OF ALL Grade 11 ABM SUBJECTS</h2>
</div></div>
        ...
        <th>Section</th>
         <th>Term</th>
          ...
          <th>View Details</th>
                ...
                <?php  $results = mysqli_query($conn, "SELECT * FROM subjecttable where course='ABM' AND yearlevel='grade 11 shs' or yearlevel='GRADE 11 SHS' AND section='abm - henry sy' or section='ABM - HENRY SY'");
